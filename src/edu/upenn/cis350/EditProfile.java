...
public class EditProfile extends Activity {
    ...
    public void updateUser(View view) {
    	...
    	final Toast successToast = Toast.makeText(this, "User " + uname + " updated.", Toast.LENGTH_SHORT);
		final Intent i = new Intent(this, Login.class);
		
		final Toast failToast = Toast.makeText(this, "Could not update user. Try again.", Toast.LENGTH_SHORT);
